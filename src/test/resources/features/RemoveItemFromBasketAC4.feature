@endtoend @inventory
Feature: Remove item from Basket - AC4
  #As a subscribed member I can remove product(s) from my cart so that I can check out cart with a only containing the items I want
